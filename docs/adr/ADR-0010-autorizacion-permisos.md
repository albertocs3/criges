...
CriGes tendrá roles base y roles personalizados. Algunos datos económicos, costes, márgenes, configuración, contabilidad y acciones críticas solo estarán disponibles para determinados roles.
