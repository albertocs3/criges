...
8. Las contraseñas quedan cifradas y ocultas.
9. El envío SMTP puede deshabilitarse sin borrar datos.
10. Sin SMTP se puede emitir, pero no enviar.
11. Existe una plantilla activa por tipo.
12. Las plantillas admiten variables y vista previa.
13. Los PDF regenerados usan la plantilla vigente.
14. Los formatos de numeración no pueden modificarse.
15. Los contadores se asignan transaccionalmente.
16. Los maestros usan numeración global.
17. Los documentos usan numeración anual.
18. Existe un panel de validación.
19. Los cambios requieren reiniciar la aplicación.
20. Toda modificación queda auditada sin exponer secretos.
